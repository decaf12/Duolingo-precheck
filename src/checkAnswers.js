...
function startsWithAtNew(target, candidate, startPos) {
  ...
  for (let pos = startPos; pos < candidateLen; pos += 1) {
    ...
    } else if (constants.IGNORED_CHARACTERS_STR.indexOf(candidateLetter) === -1) {
      return -1;
    }
  }
